...
namespace Perceptron
{
    public partial class Training : Form
    {
        ...
        // Clasifica y agrega a la gráfica todos los puntos colocados por el usuario.
        ...
        // Se encarga de almacenar el conjunto de entrenamiento en un archivo.
        private void StoreTrainingSet()
        {
            ...
            var path = Path.Combine(perceptronPath, @"Perceptron.TrainingSet.json");
